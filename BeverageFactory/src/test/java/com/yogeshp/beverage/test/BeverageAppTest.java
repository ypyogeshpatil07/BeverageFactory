...
public class BeverageAppTest {
    ...
    public void testForBlankOrder() {
        String order = "";
        Assert.assertEquals(0.0d, factory.getFinalCostForSelectedOrder(order), 0.0d);
    }

    @Test
    public void testForNormalOrder1() {
        Assert.assertEquals(2.5d, factory.getFinalCostForSelectedOrder("Chai,-milk,-water"), 0.0d);
    }

    @Test()
    public void testForNormalOrder2() {
        String order = "Chai,        -milk,     -water, Mojito,-mint, Banana Smoothie, Strawberry Shake";
        Assert.assertEquals(22.5d, factory.getFinalCostForSelectedOrder(order), 0.0d);
    }
    ...
    public void testForOrderWithNoExclusions() {
        ...
        Assert.assertEquals(9.0d, factory.getFinalCostForSelectedOrder(order), 0.0d);
    }
